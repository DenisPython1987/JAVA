...
public class GameHelper {
    ...
    private boolean coordsAvailable(int[] startuCoords){
        for(int coord : startuCoords){
            if (grid[coord] != 0) {
                return false;
            }
        }
    ...
    private void savePositionToGrid(int[] startuCoords){
        for(int index : startuCoords){
            grid[index] = 1;
        }
    }

    private ArrayList<String> convertCoordsToAlphaFormat(int[] startuCoords){
